document.addEventListener("DOMContentLoaded", function() {
    ...
    // This finds the placeholder on your pages and injects the HTML above
    const placeholders = document.querySelectorAll(".contact-info-placeholder");
    placeholders.forEach(el => el.innerHTML = contactInfoHTML);
});